...
### Ingesting data (empty `weather_measurements` renders an offline homepage, not a 500)
...
- Set `CARTO_API_KEY` for `/radar` CARTO vector basemap (free key from https://carto.com/basemaps/apikey/).
