...
class Home::CurrentWeather::SoilComponentTest < ViewComponent::TestCase
  ...
  test "renders temp humidity sensors with humidity percent and temp" do
    readings = [
      { "channel" => 1, "name" => "TH Ch 1", "humidity" => 40, "temperature_f" => 82, "battery_low" => false }
    ]
